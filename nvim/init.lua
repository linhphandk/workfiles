...
vim.keymap.set('n', '<leader>lr', builtin.lsp_references, { desc = 'Telescope live grep' })
...
vim.keymap.set("n", "<leader>mN", require("arrow.persist").previous)
vim.keymap.set("n", "<leader>mn", require("arrow.persist").next)
vim.keymap.set("n", "<leader>mm", require("arrow.persist").toggle)
